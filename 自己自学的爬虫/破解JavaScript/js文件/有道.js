this.seajs = {_seajs: this.seajs}, seajs.version = "1.3.1", seajs._util = {}, seajs._config = {
    ...
    !function (e, t) {
        ...
        var n, r, i, a = e, o = a.document, s = a.navigator, l = a.setTimeout, c = a.clearTimeout, u = a.setInterval,
            ...
            Y = new RegExp("^flash-(" + V.map(function (e) {
                ...
                if (!t) {
                    var r = qe(a.location.host, K), i = "never" === r ? "none" : "all",
    ...
    var o = e("./jquery-1.7"), s = o("#loginAlert"), l = o("#dialogCover"), c = o("#loginWindow"),
        ...
        v = "https://shared.ydstatic.com/fanyi/login/", y = null, b = {
            ...
            needMobileLogin: 1,
            skin: 0,
            placeholder: {account: "閭甯愬彿鎴栨墜鏈哄彿", pwd: "8-16浣嶅瘑鐮侊紝鍖哄垎澶у皬鍐�"},
            needPrepare: 1,
            needanimation: 1,
    ...
    t.init = function () {
        ...
        if (document.oncopy = function (e) {
            ...
            if (n.browser.msie) n('<a id="copyit" href="javascript:;" title=""></a>').appendTo("#targetCopy").show().click(function () {
                return a(), r.clog("COPY_CLICK"), n("#targetCopy .tips__text--short").text("宸插鍒�"), n(this).text("").blur(), setTimeout(function () {
                    n("#targetCopy .tips__text--short").text("澶嶅埗")
                }, 1e3), !1
            }); else {
        ...
        i(), y.on("click", function () {
            ...
            if (h.switchMode(!0), t.isDocMode = !0, t.isDocReady = !1, p("#docLangTip").show(), e && e[0] && e[0].size && (n = e[0].size), "" != (i = e && e[0] && e[0].name ? e[0].name : i.split("\\")[i.split("\\").length - 1])) {
                if (!/(.docx|.pdf|.doc)$/i.test(i)) return a(!0, {
                    msg: "鏂囨。鏍煎紡閿欒锛岀洰鍓嶄粎鏀寔doc /docx/ pdf鏍煎紡",
                    name: i,
                    size: r(n)
    ...
    return function (e, t) {
        ...
        function a(e, t, n) {
            var r = t + "defer", i = t + "queue", a = t + "mark", o = M._data(e, r);
        ...
        function v(e, t) {
            t.src ? M.ajax({
                ...
                async: !1,
                dataType: "script"
            }) : M.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Ce, "/*$0*/")), t.parentNode && t.parentNode.removeChild(t)
        }
        ...
        function b(e) {
            return function (t, n) {
                if ("string" != typeof t && (n = t, t = "*"), M.isFunction(n)) for (var r, i, a = t.toLowerCase().split(et), o = 0, s = a.length; o < s; o++) r = a[o], (i = /^\+/.test(r)) && (r = r.substr(1) || "*"), (e[r] = e[r] || [])[i ? "unshift" : "push"](n)
            }
        }
        ...
        function A(e) {
            if (!gt[e]) {
                ...
                n.remove(), "none" !== r && "" !== r || (ft || ((ft = O.createElement("iframe")).frameBorder = ft.width = ft.height = 0), t.appendChild(ft), pt && ft.createElement || ((pt = (ft.contentWindow || ft.contentDocument).document).write(("CSS1Compat" === O.compatMode ? "<!doctype html>" : "") + "<html><body>"), pt.close()), n = pt.createElement(e), pt.body.appendChild(n), r = M.css(n, "display"), t.removeChild(ft)), gt[e] = r
            }
            return gt[e]
        }
        ...
        var O = e.document, L = e.navigator, F = e.location, M = function () {
            ...
            }), (i = s.uaMatch(E)).browser && (s.browser[i.browser] = !0, s.browser.version = i.version), s.browser.webkit && (s.browser.safari = !0), d.test("聽") && (f = /^[\s\xA0]+/, p = /[\s\xA0]+$/), r = s(O), O.addEventListener ? o = function () {
        ...
        M.Callbacks = function (e) {
            ...
            var r, i, a, o, s, l = [], c = [], u = function (t) {
                var n, r, i, a;
                for (n = 0, r = t.length; n < r; n++) i = t[n], "array" === (a = M.type(i)) ? u(i) : "function" === a && (e.unique && f.has(i) || l.push(i))
            }, d = function (t, n) {
        ...
        M.extend({
            Deferred: function (e) {
                ...
                var t = R.call(arguments, 0), n = 0, r = t.length, i = new Array(r), a = r,
                    o = r <= 1 && e && M.isFunction(e.promise) ? e : M.Deferred(), s = o.promise();
                if (r > 1) {
            ...
            !g.addEventListener && g.attachEvent && g.fireEvent && (g.attachEvent("onclick", function () {
                ...
                margin: 0,
                background: "none"
            }, l && M.extend(d, {position: "absolute", left: "-999px", top: "-999px"});
        ...
        M.extend({
            ...
            data: function (e, n, r, i) {
                if (M.acceptData(e)) {
                    ...
                    if (d && u[d] && (f || i || u[d].data) || !l || r !== t) return d || (c ? e[M.expando] = d = ++M.uuid : d = M.expando), u[d] || (u[d] = {}, c || (u[d].toJSON = M.noop)), "object" != typeof n && "function" != typeof n || (i ? u[d] = M.extend(u[d], n) : u[d].data = M.extend(u[d].data, n)), a = o = u[d], i || (o.data || (o.data = {}), o = o.data), r !== t && (o[M.camelCase(n)] = r), f && !o[n] ? a.events : (l ? null == (s = o[n]) && (s = o[M.camelCase(n)]) : s = o, s)
                }
            },
            ...
            data: function (e, n) {
                ...
                if (void 0 === e) {
                    if (this.length && (s = M.data(this[0]), 1 === this[0].nodeType && !M._data(this[0], "parsedAttrs"))) {
                        for (var l = 0, c = (a = this[0].attributes).length; l < c; l++) 0 === (o = a[l].name).indexOf("data-") && (o = M.camelCase(o.substring(5)), r(this[0], o, s[o]));
            ...
            _mark: function (e, t) {
                ...
                "inprogress" === r && (r = n.shift()), r && ("fx" === t && n.unshift("inprogress"), M._data(e, t + ".run", i), r.call(e, function () {
                    M.dequeue(e, t)
                }, i)), n.length || (M.removeData(e, t + "queue " + t + ".run", !0), a(e, t, "queue"))
            }
        }), M.fn.extend({
            queue: function (e, n) {
        ...
        M.fn.extend({
            attr: function (e, t) {
                ...
                return M.isFunction(e) ? this.each(function (n) {
                    ...
                    if ("string" === n) for (var i, a = 0, o = M(this), s = t, l = e.split(W); i = l[a++];) o[(s = r ? s : !o.hasClass(i)) ? "addClass" : "removeClass"](i); else "undefined" !== n && "boolean" !== n || (this.className && M._data(this, "__className__", this.className), this.className = this.className || !1 === e ? "" : M._data(this, "__className__") || "")
                })
            }, hasClass: function (e) {
            ...
            removeAttr: function (e, t) {
                var n, r, i, a, o = 0;
                if (1 === e.nodeType) for (a = (r = (t || "").split(W)).length; o < a; o++) i = r[o].toLowerCase(), n = M.propFix[i] || i, M.attr(e, i, ""), e.removeAttribute(K ? i : n), Z.test(i) && n in e && (e[n] = !1)
            },
            attrHooks: {
                type: {
                    set: function (e, t) {
        ...
        }, K || (B = {name: !0, id: !0}, z = M.valHooks.button = {
            get: function (e, n) {
                var r;
        ...
        }, M.attrHooks.tabindex.set = z.set, M.each(["width", "height"], function (e, t) {
        ...
        M.event = {
            add: function (e, n, r, i, a) {
                ...
                if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (o = M._data(e))) {
                    for (r.handler && (r = (h = r).handler), r.guid || (r.guid = M.guid++), (l = o.events) || (o.events = l = {}), (s = o.handle) || (o.handle = s = function (e) {
                    ...
                    }, s.elem = e), n = ae(n).split(" "), c = 0; c < n.length; c++) d = (u = J.exec(n[c]) || [])[1], f = (u[2] || "").split(".").sort(), g = M.event.special[d] || {}, d = (a ? g.delegateType : g.bindType) || d, g = M.event.special[d] || {}, p = M.extend({
                        type: d,
                        origType: u[1],
                        data: i,
                        handler: r,
                        ...
                        selector: a,
                        namespace: f.join(".")
                    }, h), a && (p.quick = re(a), !p.quick && M.expr.match.POS.test(a) && (p.isPositional = !0)), (m = l[d]) || ((m = l[d] = []).delegateCount = 0, g.setup && !1 !== g.setup.call(e, i, f, s) || (e.addEventListener ? e.addEventListener(d, s, !1) : e.attachEvent && e.attachEvent("on" + d, s))), g.add && (g.add.call(e, p), p.handler.guid || (p.handler.guid = r.guid)), a ? m.splice(m.delegateCount++, 0, p) : m.push(p), M.event.global[d] = !0;
                    e = null
                }
            },
            global: {},
            remove: function (e, t, n, r) {
                ...
                if (m && (u = m.events)) {
                    for (t = ae(t || "").split(" "), i = 0; i < t.length; i++) {
                        ...
                        if (d = M.event.special[o] || {}, o = (r ? d.delegateType : d.bindType) || o, p = u[o] || [], l = p.length, s = s ? new RegExp("(^|\\.)" + s.split(".").sort().join("\\.(?:.*\\.)?") + "(\\.|$)") : null, n || s || r || d.remove) for (c = 0; c < p.length; c++) h = p[c], n && n.guid !== h.guid || s && !s.test(h.namespace) || (!r || r === h.selector || "**" === r && h.selector) && (p.splice(c--, 1), h.selector && p.delegateCount--, d.remove && d.remove.call(e, h)); else p.length = 0;
                ...
                if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                    ...
                    if (g.indexOf("!") >= 0 && (g = g.slice(0, -1), s = !0), g.indexOf(".") >= 0 && (g = (v = g.split(".")).shift(), v.sort()), i && !M.event.customEvent[g] || M.event.global[g]) if (n = "object" == typeof n ? n[M.expando] ? n : new M.Event(g, n) : new M.Event(g), n.type = g, n.isTrigger = !0, n.exclusive = s, n.namespace = v.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.)?") + "(\\.|$)") : null, d = g.indexOf(":") < 0 ? "on" + g : "", !a && i || n.preventDefault(), i) {
                        if (n.result = t, n.target || (n.target = i), (r = null != r ? M.makeArray(r) : []).unshift(n), !(f = M.event.special[g] || {}).trigger || !1 !== f.trigger.apply(i, r)) {
                            ...
                            return n.type = g, n.isDefaultPrevented() || f._default && !1 !== f._default.apply(i.ownerDocument, r) || "click" === g && M.nodeName(i, "a") || !M.acceptData(i) || d && i[g] && ("focus" !== g && "blur" !== g || 0 !== n.target.offsetWidth) && !M.isWindow(i) && ((u = i[d]) && (i[d] = null), M.event.triggered = g, i[g](), M.event.triggered = t, u && (i[d] = u)), n.result
                        }
                    } else {
                        o = M.cache;
            ...
            dispatch: function (n) {
                ...
                if (m[0] = n, n.delegateTarget = this, h && !n.target.disabled && (!n.button || "click" !== n.type)) for (a = n.target; a != this; a = a.parentNode || this) {
                    for (s = {}, c = [], r = 0; r < h; r++) f = s[d = (u = p[r]).selector], u.isPositional ? f = (f || (s[d] = M(d))).index(a) >= 0 : f === t && (f = s[d] = u.quick ? ie(a, u.quick) : M(a).is(d)), f && c.push(u);
            ...
            e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || !1 === e.returnValue || e.getPreventDefault && e.getPreventDefault() ? s : o) : this.type = e, t && M.extend(this, t), this.timeStamp = e && e.timeStamp || M.now(), this[M.expando] = !0
        }, M.Event.prototype = {
            ...
            M.event.special[e] = M.event.special[t] = {
                delegateType: t, bindType: t, handle: function (e) {
                    ...
                    a.selector;
                    return i && a.origType !== e.type && (i === r || M.contains(r, i)) || (t = e.type, e.type = a.origType, n = a.handler.apply(this, arguments), e.type = t), n
                }
            }
        ...
        var oe = /Until$/, se = /^(?:parents|prevUntil|prevAll)/, le = /,/, ce = /^.[^:#\[\.,]*$/,
            ue = Array.prototype.slice, de = M.expr.match.POS, fe = {children: !0, contents: !0, next: !0, prev: !0};
        M.fn.extend({
            find: function (e) {
                var t, n, r = this;
                ...
                if (M.isArray(e)) {
                    for (var o = 1; a && a.ownerDocument && a !== t;) {
                        for (n = 0; n < e.length; n++) M(a).is(e[n]) && i.push({selector: e[n], elem: a, level: o});
                        a = a.parentNode, o++
                    }
                    return i
                }
            ...
            M.fn[e] = function (n, r) {
                var i = M.map(this, t, n), a = ue.call(arguments);
                return oe.test(e) || (r = n), r && "string" == typeof r && (i = M.filter(r, i)), i = this.length > 1 && !fe[e] ? M.unique(i) : i, (this.length > 1 || le.test(r)) && se.test(e) && (i = i.reverse()), this.pushStack(i, e, a.join(","))
            }
        }), M.extend({
            filter: function (e, t, n) {
                return n && (e = ":not(" + e + ")"), 1 === t.length ? M.find.matchesSelector(t[0], e) ? [t[0]] : [] : M.find.matches(e, t)
            }, dir: function (e, n, r) {
                for (var i = [], a = e[n]; a && 9 !== a.nodeType && (r === t || 1 !== a.nodeType || !M(a).is(r));) 1 === a.nodeType && i.push(a), a = a[n];
                return i
        ...
        Se.optgroup = Se.option, Se.tbody = Se.tfoot = Se.colgroup = Se.caption = Se.thead, Se.th = Se.td, M.support.htmlSerialize || (Se._default = [1, "div<div>", "</div>"]), M.fn.extend({
            text: function (e) {
                ...
                if (this[0]) {
                    if (s = l && l.parentNode, i = M.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {fragment: s} : M.buildFragment(e, this, c), o = i.fragment, a = 1 === o.childNodes.length ? o = o.firstChild : o.firstChild) {
                        n = n && M.nodeName(a, "tr");
                        for (var u = 0, f = this.length, p = f - 1; u < f; u++) r.call(n ? d(this[u]) : this[u], i.cacheable || f > 1 && u < p ? M.clone(o, !0, !0) : o)
                    }
                    c.length && M.each(c, v)
                }
                return this
            ...
            var r, i, a, o, s = e[0];
            return t && t[0] && (o = t[0].ownerDocument || t[0]), o.createDocumentFragment || (o = O), 1 === e.length && "string" == typeof s && s.length < 512 && o === O && "<" === s.charAt(0) && !we.test(s) && (M.support.checkClone || !_e.test(s)) && !M.support.unknownElems && Te.test(s) && (i = !0, (a = M.fragments[s]) && 1 !== a && (r = a)), r || (r = o.createDocumentFragment(), M.clean(e, o, r, n)), i && (M.fragments[s] = a ? r : 1), {
                fragment: r,
                cacheable: i
            }
        }, M.fragments = {}, M.each({
            ...
            clone: function (e, t, n) {
                ...
                for (var a, o, s = [], l = 0; null != (o = e[l]); l++) if ("number" == typeof o && (o += ""), o) {
                    if ("string" == typeof o) if (be.test(o)) {
                        ...
                        !M.support.leadingWhitespace && me.test(o) && p.insertBefore(t.createTextNode(me.exec(o)[0]), p.firstChild), o = p.childNodes
                    } else o = t.createTextNode(o);
                    var v;
                    if (!M.support.appendChecked) if (o[0] && "number" == typeof (v = o.length)) for (a = 0; a < v; a++) g(o[a]); else g(o);
                ...
                for (var t, n, r, i = M.cache, a = M.event.special, o = M.support.deleteExpando, s = 0; null != (r = e[s]); s++) if ((!r.nodeName || !M.noData[r.nodeName.toLowerCase()]) && (n = r[M.expando])) {
                    if ((t = i[n]) && t.events) {
                        for (var l in t.events) a[l] ? M.event.remove(r, l) : M.removeEvent(r, l, t.handle);
                        t.handle && (t.handle.elem = null)
                    }
                    o ? delete r[M.expando] : r.removeAttribute && r.removeAttribute(M.expando), delete i[n]
                }
            }
        });
        ...
        M.fn.css = function (e, n) {
            ...
            css: function (e, n, r) {
                var i, a;
                return n = M.camelCase(n), a = M.cssHooks[n], "cssFloat" === (n = M.cssProps[n] || n) && (n = "float"), a && "get" in a && (i = a.get(e, !0, r)) !== t ? i : je ? je(e, n) : void 0
            },
            swap: function (e, t, n) {
                var r = {};
            ...
            M.cssHooks[t] = {
                get: function (e, n, r) {
                    var i;
                    if (n) return 0 !== e.offsetWidth ? y(e, t, r) : (M.swap(e, Re, function () {
                        i = y(e, t, r)
                    }), i)
                }, set: function (e, t) {
            ...
            get: function (e, t) {
                ...
                n.zoom = 1, t >= 1 && "" === M.trim(a.replace(De, "")) && (n.removeAttribute("filter"), r && !r.filter) || (n.filter = De.test(a) ? a.replace(De, i) : a + " " + i)
            }
        }), M(function () {
            ...
            var r, i, a;
            return n = n.replace(Le, "-$1").toLowerCase(), (i = e.ownerDocument.defaultView) ? ((a = i.getComputedStyle(e, null)) && ("" !== (r = a.getPropertyValue(n)) || M.contains(e.ownerDocument.documentElement, e) || (r = M.style(e, n))), r) : t
        }), O.documentElement.currentStyle && (Ae = function (e, t) {
            var n, r, i, a = e.currentStyle && e.currentStyle[t], o = e.style;
            return null === a && o && (i = o[t]) && (a = i), !Fe.test(a) && Me.test(a) && (n = o.left, (r = e.runtimeStyle && e.runtimeStyle.left) && (e.runtimeStyle.left = e.currentStyle.left), o.left = "fontSize" === t ? "1em" : a || 0, a = o.pixelLeft + "px", o.left = n, r && (e.runtimeStyle.left = r)), "" === a ? "auto" : a
        ...
        Pe = nt.exec(ze.toLowerCase()) || [], M.fn.extend({
            load: function (e, n, r) {
                ...
                return M.ajax({
                    url: e, type: o, dataType: "html", data: n, complete: function (e, t, n) {
                        n = e.responseText, e.isResolved() && (e.done(function (e) {
                            n = e
                        }), s.html(a ? M("<div>").append(n.replace(Je, "")).find(a) : n)), r && s.each(r, [n, t, e])
                    }
                }), this
            }, serialize: function () {
            ...
            M[n] = function (e, r, i, a) {
                return M.isFunction(r) && (a = a || i, i = r, r = t), M.ajax({
                    type: n,
                    url: e,
                    data: r,
                    success: i,
            ...
            ajax: function (e, n) {
                function r(e, n, r, o) {
                    if (2 !== w) {
                        ...
                        if (e >= 200 && e < 300 || 304 === e) if (f.ifModified && ((b = T.getResponseHeader("Last-Modified")) && (M.lastModified[i] = b), (x = T.getResponseHeader("Etag")) && (M.etag[i] = x)), 304 === e) C = "notmodified", c = !0; else try {
                            d = k(f, S), C = "success", c = !0
                        } catch (e) {
                            C = "parsererror", y = e
                        } else y = C, C && !e || (C = "error", e < 0 && (e = 0));
                        T.status = e, T.statusText = "" + (n || C), c ? m.resolveWith(p, [d, C, T]) : m.rejectWith(p, [T, C, y]), T.statusCode(v), v = t, u && h.trigger("ajax" + (c ? "Success" : "Error"), [T, f, c ? d : y]), g.fireWith(p, [T, C]), u && (h.trigger("ajaxComplete", [T, f]), --M.active || M.event.trigger("ajaxStop"))
                    }
                }
                ...
                if (u = f.global, f.type = f.type.toUpperCase(), f.hasContent = !Ze.test(f.type), u && 0 == M.active++ && M.event.trigger("ajaxStart"), !f.hasContent && (f.data && (f.url += (Ge.test(f.url) ? "&" : "?") + f.data, delete f.data), i = f.url, !1 === f.cache)) {
                    var C = M.now(), S = f.url.replace(tt, "$1_=" + C);
                    f.url = S + (S === f.url ? (Ge.test(f.url) ? "&" : "?") + "_=" + C : "")
                }
                (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && T.setRequestHeader("Content-Type", f.contentType), f.ifModified && (i = i || f.url, M.lastModified[i] && T.setRequestHeader("If-Modified-Since", M.lastModified[i]), M.etag[i] && T.setRequestHeader("If-None-Match", M.etag[i])), T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + ot + "; q=0.01" : "") : f.accepts["*"]);
        ...
        M.ajaxSetup({
            ...
            if ("jsonp" === t.dataTypes[0] || !1 !== t.jsonp && (lt.test(t.url) || i && lt.test(t.data))) {
                ...
                return !1 !== t.jsonp && (l = l.replace(lt, u), t.url === l && (i && (c = c.replace(lt, u)), t.data === c && (l += (/\?/.test(l) ? "&" : "?") + t.jsonp + "=" + o))), t.url = l, t.data = c, e[o] = function (e) {
                    ...
                    e[o] = s, a && M.isFunction(s) && e[o](a[0])
                ...
                return {
                    send: function (i, a) {
                        ...
                        l.send(n.hasContent && n.data || null), r = function (e, i) {
                            var s, c, u, d, f;
                            try {
                                if (r && (i || 4 === l.readyState)) if (r = t, o && (l.onreadystatechange = M.noop, ut && delete ct[o]), i) 4 !== l.readyState && l.abort(); else {
                            ...
                            d && a(s, c, d, u)
                        }, n.async && 4 !== l.readyState ? (o = ++dt, ut && (ct || (ct = {}, M(e).unload(ut)), ct[o] = r), l.onreadystatechange = r) : r()
                    }, abort: function () {
                        r && r(0, 1)
                    }
                }
        ...
        M.fn.extend({
            show: function (e, t, n) {
                ...
                for (var a = 0, o = this.length; a < o; a++) (r = this[a]).style && (i = r.style.display, M._data(r, "olddisplay") || "none" !== i || (i = r.style.display = ""), "" === i && "none" === M.css(r, "display") && M._data(r, "olddisplay", A(r.nodeName)));
                ...
                for (var r, i, a = 0, o = this.length; a < o; a++) (r = this[a]).style && ("none" === (i = M.css(r, "display")) || M._data(r, "olddisplay") || M._data(r, "olddisplay", i));
                ...
                function i() {
                    ...
                    for (r in e) {
                        if (t = M.camelCase(r), r !== t && (e[t] = e[r], delete e[r]), n = e[t], M.isArray(n) ? (d.animatedProperties[t] = n[1], n = e[t] = n[0]) : d.animatedProperties[t] = d.specialEasing && d.specialEasing[t] || d.easing || "swing", "hide" === n && p || "show" === n && !p) return d.complete.call(this);
                        !f || "height" !== t && "width" !== t || (d.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], "inline" === M.css(this, "display") && "none" === M.css(this, "float") && (M.support.inlineBlockNeedsLayout && "inline" !== A(this.nodeName) ? this.style.zoom = 1 : this.style.display = "inline-block"))
                    }
                    null != d.overflow && (this.style.overflow = "hidden");
                    for (r in e) i = new M.fx(this, d, r), n = e[r], vt.test(n) ? (u = M._data(this, "toggle" + r) || ("toggle" === n ? p ? "show" : "hide" : 0)) ? (M._data(this, "toggle" + r, "show" === u ? "hide" : "show"), i[u]()) : i[n]() : (o = yt.exec(n), s = i.cur(), o ? (l = parseFloat(o[2]), "px" !== (c = o[3] || (M.cssNumber[r] ? "" : "px")) && (M.style(this, r, (l || 1) + c), s = (l || 1) / i.cur() * s, M.style(this, r, s + c)), o[1] && (l = ("-=" === o[1] ? -1 : 1) * l + s), i.custom(s, l, c)) : i.custom(s, n, ""));
                    return !0
                }

                var a = M.speed(t, n, r);
                return M.isEmptyObject(e) ? this.each(a.complete, [!1]) : (e = M.extend({}, e), !1 === a.queue ? this.each(i) : this.queue(a.queue, i))
            }, stop: function (e, n, r) {
                return "string" != typeof e && (r = n, n = e, e = t), n && !1 !== e && this.queue(e || "fx", []), this.each(function () {
                    ...
                    if (r || M._unmark(!0, this), null == e) for (n in o) o[n].stop && n.indexOf(".run") === n.length - 4 && t(this, o, n); else o[n = e + ".run"] && o[n].stop && t(this, o, n);
            ...
            update: function () {
                ...
                if (e || i >= s.duration + this.startTime) {
                    ...
                    if (a) {
                        ...
                        }), s.hide && M(o).hide(), s.hide || s.show) for (t in s.animatedProperties) M.style(o, t, s.orig[t]), M.removeData(o, "fxshow" + t, !0), M.removeData(o, "toggle" + t, !0);
        ...
        "getBoundingClientRect" in O.documentElement ? M.fn.offset = function (e) {
            ...
            return "relative" !== l.position && "static" !== l.position || (c += o.offsetTop, u += o.offsetLeft), M.support.fixedPosition && "fixed" === l.position && (c += Math.max(a.scrollTop, o.scrollTop), u += Math.max(a.scrollLeft, o.scrollLeft)), {
                top: c,
                left: u
            }
        }, M.offset = {
            bodyOffset: function (e) {
                ...
                ("absolute" === r || "fixed" === r) && M.inArray("auto", [l, c]) > -1 ? (i = (d = o.position()).top, a = d.left) : (i = parseFloat(l) || 0, a = parseFloat(c) || 0), M.isFunction(t) && (t = t.call(e, n, s)), null != t.top && (u.top = t.top - s.top + i), null != t.left && (u.left = t.left - s.left + a), "using" in t ? t.using.call(e, u) : o.css(u)
            }
        }, M.fn.extend({
            position: function () {
    ...
    var r = function (e) {
        ...
        return {ts: r, bv: t, salt: i, sign: n.md5("fanyideskweb" + e + i + "Nw(nmmbP%A-r6U3EUn]Aj")}
    };
    ...
    function o(e) {
        function t(e) {
            ...
            return n = n.split("禄"), "from" === e ? t ? "auto" : a(n[0]) : "to" === e ? t ? "auto" : a(n[1]) : void 0
        }
